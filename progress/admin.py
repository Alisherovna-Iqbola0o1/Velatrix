...
from .models import (
    LessonProgress, LessonAttempt, QuestionAttempt, LessonChatMessage,
    DailyProgress, ExtremalTestAttempt, XPTransaction, QuestionReport,
)
...
class DailyProgressAdmin(admin.ModelAdmin):
    list_display = ('user', 'date', 'lessons_completed_today', 'extremal_test_used_today')
