...
from .models import LessonProgress, DailyProgress, XPTransaction, LessonAttempt
from .serializers import (
    LessonProgressSerializer, DailyProgressSerializer,
    XPTransactionSerializer, QuestionReportSerializer,
...
class StartLessonView(APIView):
    ...
    def post(self, request, lesson_id):
        ...
        return Response({'attempt_id': attempt.id, 'attempt_number': attempt.attempt_number})
...
class SubmitAnswerView(APIView):
    ...
    def post(self, request, attempt_id):
        ...
        try:
            attempt = LessonAttempt.objects.get(id=attempt_id, user=request.user, result='in_progress')
        ...
        result = submit_answer(request.user, attempt, question, serializer.validated_data['answer'])
